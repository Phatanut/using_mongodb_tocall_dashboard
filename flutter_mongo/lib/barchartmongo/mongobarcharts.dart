...
class MongoBars extends StatefulWidget {
  const MongoBars({super.key});

  @override
  State<MongoBars> createState() => _MongoBarsState();
}

class _MongoBarsState extends State<MongoBars> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Fetch Data Bar Chart Form"),
